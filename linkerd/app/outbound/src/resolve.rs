...
type ResolveStack<R> =
    map_endpoint::Resolve<EndpointFromMetadata, Filter<ResolveService<R>, AllowResolve>>;
    ...
    R::Resolution: Send,
{
    map_endpoint::Resolve::new(
        ...
        Filter::new(resolve.into_service(), AllowResolve),
    )
}
...
impl<P> Predicate<Concrete<P>> for AllowResolve {
    ...
    fn check(&mut self, target: Concrete<P>) -> Result<Addr, Error> {
        // TODO We must have a name to resolve to get here. This should be
